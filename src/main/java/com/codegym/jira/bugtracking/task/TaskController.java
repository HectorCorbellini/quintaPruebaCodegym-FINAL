...
public class TaskController {
     ...
     */
    @PostMapping("/{id}/tags")
    public Set<String> addTag(@PathVariable long id, @NotBlank @RequestParam String tag) {
    ...
    public Set<String> removeTag(@PathVariable long id, @NotBlank @RequestParam String tag) {
        log.info("remove tag {} from task with id={}", tag, id);
        return taskService.removeTag(id, tag);
    }
     ...
     */
    @PutMapping("/{id}/tags")
    public Set<String> setTags(@PathVariable long id, @RequestBody Set<String> tags) {
        log.info("set tags {} for task with id={}", tags, id);
        return taskService.setTags(id, tags);
    }
