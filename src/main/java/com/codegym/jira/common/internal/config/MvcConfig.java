...
public class MvcConfig implements WebMvcConfigurer {
    ...
    // Ya no es necesario con la configuración estándar de Spring Boot
    // Las vistas ahora se sirven desde src/main/resources/templates/
    @Bean
    public SimpleUrlHandlerMapping getUrlHandlerMapping() {
        return new SimpleUrlHandlerMapping() {{
            setMappings(new Properties() {{
                // Mantener esta configuración para compatibilidad con código existente
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        // Usar la ubicación estándar de Spring Boot para los recursos estáticos
