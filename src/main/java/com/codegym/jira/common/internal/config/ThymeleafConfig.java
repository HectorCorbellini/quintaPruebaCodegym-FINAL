...
public class ThymeleafConfig {
    ...
    public SpringTemplateEngine thymeleafTemplateEngine() {
        ...
        // Usar la ruta estándar de Spring Boot para las plantillas
        FileTemplateResolver viewResolver = createTemplateResolver("./src/main/resources/templates/");
        viewResolver.setCheckExistence(true);
        viewResolver.setOrder(1);
        // Usar la ruta estándar de Spring Boot para los correos electrónicos
        FileTemplateResolver mailResolver = createTemplateResolver("./src/main/resources/templates/mails/");
